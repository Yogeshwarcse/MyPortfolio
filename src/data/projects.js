const projects = [
  ...
  },
  {
    ...
    description: 'Developed a full-featured Blood Bank website that efficiently manages donors, blood stock, and appointments, while providing real-time insights into donations, blood group distribution, and collection site analytics. The platform features a user-friendly interface with well-structured components for seamless navigation, ensuring both donors and administrators can interact effortlessly. It is designed for quick deployment on Vercel, offering fast performance and accessibility, while delivering actionable reports and visual analytics to support effective blood donation management.',
    link: 'https://blood-bank-ruby.vercel.app/',
    tech: ['Mongo', 'Next.js', 'Tailwind CSS', 'Node.js', 'Express.js', 'MongoDB']
  },
  {
    title: 'Online Clothing Website',
